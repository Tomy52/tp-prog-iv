...
@Component({
  selector: 'app-product-supplier-section',
  imports: [
    ProductSupplierFormComponent
  ],
  templateUrl: './product-supplier-section.html',
  styleUrl: './product-supplier-section.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ProductSupplierSection implements OnInit {
