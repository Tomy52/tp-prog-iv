...
import {ResponsePrice} from '../../../../interfaces/product-supplier/response-price';
import {ActivatedRoute, Router, RouterLink} from "@angular/router";
import {ProductSupplierService} from "../../../../services/product-supplier-service";

@Component({
  selector: 'tr[app-product-supplier-row-component]',
  imports: [
    RouterLink
  ],
...
export class ProductSupplierRowComponent {
  ...
  productPrice = input.required<ResponsePrice>();
